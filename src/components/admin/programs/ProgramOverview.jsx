...
export default function ProgramOverview({ onSelect }) {
  ...
  const [form, setForm] = useState({ program_name: "", age_group: "Youth", default_monthly_rate: 120, max_capacity: 25, description: "" });
  ...
  const handleAdd = async (e) => {
    ...
    try {
      ...
      setShowAdd(false);
      setForm({ program_name: "", age_group: "Youth", default_monthly_rate: 120, max_capacity: 25, description: "" });
      load();
